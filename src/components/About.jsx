      ...
      <div className="flex flex-col md:flex-row justify-between items-center space-y-8 md:space-y-0 md:space-x-10 mx-auto">
        ...
        <div data-aos="fade-up" data-aos-delay="600" className="flex-1 relative w-full">
          <img
            ...
            alt="Gym Image"
            className="max-w-full sm:max-w-[400px] md:w-[500px] lg:w-[600px] xl:w-[700px] mx-auto rounded-lg object-cover transition-transform duration-500 transform hover:scale-105 hover:shadow-xl"
          />
        </div>
      </div>
